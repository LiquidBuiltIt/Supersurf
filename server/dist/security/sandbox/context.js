...
exports.DEFAULT_EXPORT_KEY = void 0;
exports.stripModuleSyntax = stripModuleSyntax;
exports.createPlaybookContext = createPlaybookContext;
exports.compilePlaybook = compilePlaybook;
const vm_1 = __importDefault(require("vm"));
const acorn = __importStar(require("acorn"));
/** The context property the playbook's default export is assigned to. */
exports.DEFAULT_EXPORT_KEY = '__pb_default';
...
function stripModuleSyntax(source) {
    ...
    for (const node of ast.body) {
        if (node.type === 'ExportDefaultDeclaration') {
            ...
            const assign = `${exports.DEFAULT_EXPORT_KEY} =`;
 ...
 */
function createPlaybookContext(globals) {
    ...
    sandbox[exports.DEFAULT_EXPORT_KEY] = undefined;
    ...
    new vm_1.default.Script('Object.setPrototypeOf(globalThis, null);').runInContext(context);
    ...
    new vm_1.default.Script(BOOTSTRAP).runInContext(context);
    return context;
}
/**
 ...
 */
function compilePlaybook(source, filename) {
    return new vm_1.default.Script(stripModuleSyntax(source), {
        filename,
