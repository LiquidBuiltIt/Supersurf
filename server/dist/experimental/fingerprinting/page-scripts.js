...
exports.captureExpr = captureExpr;
exports.scoreExpr = scoreExpr;
...
function captureExpr(selector) {
    const elExpr = (0, element_resolver_1.getSelectorExpression)(selector);
